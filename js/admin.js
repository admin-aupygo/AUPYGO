...
(function () {
  ...
  function injectAdminPage() {
    ...
    section.innerHTML =
      '<div class="section-title" style="margin-bottom:20px">' +
        ...
        '<p style="margin:0;color:#64748b;font-size:14px">Gestion des membres, rôles et équipe Aupygo (charte organisationnelle)</p>' +
      '</div>' +
  ...
  window.adminSetRole = async function (userId, newRole) {
    ...
    if (!confirm('Changer le rôle en « ' + label + ' » ?\n\nPour les Sergents/Majors, pense à renseigner staff_country / staff_city ensuite.')) return;
